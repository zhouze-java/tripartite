 ...
 * @author gaigeshen
 */
public interface JiangSuOnlineAccessTokenUpdateTask extends Runnable {
    /**
     * 设置访问令牌存储器到此任务，此存储器用于获取访问令牌和保存更新之后的访问令牌
     *
     * @param accessTokenStore 访问令牌存储器
     */
    void setAccessTokenStore(JiangSuOnlineAccessTokenStore accessTokenStore);
     ...
     */
    void setAccessTokenUpdateListener(JiangSuOnlineAccessTokenUpdateListener accessTokenUpdateListener);
     ...
     * @param config 配置信息
     */
    void setConfig(JiangSuOnlineConfig config);
     ...
     * @return 访问令牌存储器
     */
    JiangSuOnlineAccessTokenStore getAccessTokenStore();
     ...
     * @return 访问令牌更新监听器
     */
    JiangSuOnlineAccessTokenUpdateListener getAccessTokenUpdateListener();
