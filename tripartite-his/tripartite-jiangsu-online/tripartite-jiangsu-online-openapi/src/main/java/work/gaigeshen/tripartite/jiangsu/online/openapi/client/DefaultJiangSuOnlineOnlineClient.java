 ...
 * @author gaigeshen
 */
class DefaultJiangSuOnlineOnlineClient extends JiangSuOnlineAbstractClient implements HisProcurementOnLineClient {

    DefaultJiangSuOnlineOnlineClient(JiangSuOnlineConfig config, WebExecutor executor) {
        super(config, executor);
    }

    static DefaultJiangSuOnlineOnlineClient create(JiangSuOnlineConfig config, AbstractInterceptor... interceptors) {
        ...
        return new DefaultJiangSuOnlineOnlineClient(config, executor);
    }
